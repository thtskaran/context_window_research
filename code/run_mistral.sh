...
# Clean previous results for this model only (keep Qwen results)
rm -f results/${MODEL_SLUG}_results.jsonl results/${MODEL_SLUG}_judged.jsonl
mkdir -p results figures

# Step 1: Run experiment (async, concurrent)
echo ""
...
# Step 2: LLM judge (async, concurrent)
echo ""
...
# Step 3: Figures + stats (will include both models if Qwen results exist)
echo ""
